...
const Formulario = ({ pacientes, setPacientes, paciente, setPaciente }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (paciente.id) {
      ...
      setPacientes([...pacientes, objetoPaciente]); //Llenar arreglo
    }
    ...
    <div className="md:w-1/2 lg:w-2/5 mx-5">
      ...
      >
        ...
        <input
          ...
          className="w-full bg-indigo-600 p-3 text-white font-bold hover:bg-indigo-700 cursor-pointer transition-all uppercase duration-200"
        />
      </form>
    </div>
  );
